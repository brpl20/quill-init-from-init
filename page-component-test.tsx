...
import { Plus, X, Type, Bold, Italic, List, AlignLeft, AlignCenter } from 'lucide-react';
  ...
  return (
    <div className="h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-white border-b border-gray-200 p-4 flex items-center justify-between">
        <h1 className="text-xl font-semibold text-gray-800">Multi-Page Editor</h1>
        <button
          onClick={addPage}
          ...
          {pages.map((page) => (
            ...
            >
              ...
              <div
                ...
                onFocus={() => setActivePage(page.id)}
                onInput={(e) => updatePageContent(page.id, e.target.innerHTML)}
          ...
          <button
            ...
            onClick={() => {
              ...
              if (pageElement && scrollContainerRef.current) {
                ...
                const scrollLeft = pageRect.left - containerRect.left + scrollContainerRef.current.scrollLeft - 24;
